      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close data-slot="sheet-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-4 right-4 bg-oklch(0.96 0.002 17.2) dark:bg-oklch(0.268 0.011 36.5)"
              size="icon-sm"
            >
              <XIcon
              />
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "text-lg font-semibold tracking-wider text-oklch(0.147 0.004 49.3) uppercase dark:text-oklch(0.986 0.002 67.8)",
        className
      )}
      {...props}
    />
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn(
        "mt-0.5 text-sm leading-relaxed text-oklch(0.547 0.021 43.1) dark:text-oklch(0.714 0.014 41.2)",
        className
      )}
      {...props}
    />
